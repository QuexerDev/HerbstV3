...
import me.quexer.api.quexerapi.database.RabbitMQ;
import me.quexer.api.quexerapi.database.RabbitMQConsumer;
import me.quexer.api.quexerapi.misc.AsyncTask;
import me.quexer.herbst.herbstplugin.game.GameAPI;
import me.quexer.herbst.herbstplugin.manager.BackendManager;
import me.quexer.herbst.herbstplugin.manager.BackendPlayerManager;
import me.quexer.herbst.herbstplugin.manager.FriendManager;
...
public abstract class HerbstPlugin extends JavaPlugin {

    private HerbstPlugin instance;
    ...
    public void onEnable() {
        ...
        rabbitMQConsumer = new RabbitMQConsumer("herbst-bungee");
    ...
    public abstract GameAPI initGameAPI();
    ...
    public HerbstPlugin getInstance() {
        return instance;
    }
